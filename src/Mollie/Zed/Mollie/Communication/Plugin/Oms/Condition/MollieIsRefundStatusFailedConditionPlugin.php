 ...
 */
class MollieIsRefundStatusFailedConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * @var string
     */
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $refund->getRefund()->getStatus() === static::REFUND_STATUS_FAILED;
    }
}
