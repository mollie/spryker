 ...
 */
class MollieIsPaymentLinkStatusPaidConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $this->getFacade()->isPaymentLinkStatusPaid($idSalesOrder);
    }
}
