 ...
 */
class MollieIsPaymentLinkStatusExpiredConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $this->getFacade()->isPaymentLinkStatusExpired($idSalesOrder);
    }
}
