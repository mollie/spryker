 ...
 */
class MollieIsPaymentStatusPaidConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * @var string
     */
    protected const PAYMENT_STATUS_PAID = 'paid';
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $payment->getStatus() === static::PAYMENT_STATUS_PAID;
    }
}
