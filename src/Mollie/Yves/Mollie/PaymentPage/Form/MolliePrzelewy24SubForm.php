...
class MolliePrzelewy24SubForm extends AbstractSubFormType implements SubFormInterface, SubFormProviderNameInterface
{
    /**
     * @var string
     */
    ...
    {
        return MollieConfig::MOLLIE_PROVIDER_PRZELEWY24 . DIRECTORY_SEPARATOR . static::PAYMENT_METHOD;
    }
