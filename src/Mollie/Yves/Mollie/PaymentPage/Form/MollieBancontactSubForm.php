...
class MollieBancontactSubForm extends AbstractSubFormType implements SubFormInterface, SubFormProviderNameInterface
{
    /**
     * @var string
     */
    ...
    {
        return MollieConfig::MOLLIE_PAYMENT_BANCONTACT;
    }
