 ...
 */
class MollieRivertyPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMollieRivertyPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
