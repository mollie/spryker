 ...
 */
class MollieTwintPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMolliePaymentTwintHandler()->addPaymentToQuote($dataTransfer);
    }
}
