 ...
 */
class MolliePayconiqPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMolliePayconiqPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
