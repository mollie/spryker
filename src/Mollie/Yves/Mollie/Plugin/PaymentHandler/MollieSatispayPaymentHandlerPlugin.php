 ...
 */
class MollieSatispayPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMolliePaymentSatispayHandler()->addPaymentToQuote($dataTransfer);
    }
}
