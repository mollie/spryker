 ...
 */
class MollieKbcPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMollieKbcPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
