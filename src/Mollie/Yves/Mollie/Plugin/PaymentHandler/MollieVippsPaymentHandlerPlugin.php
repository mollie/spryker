 ...
 */
class MollieVippsPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMolliePaymentVippsHandler()->addPaymentToQuote($dataTransfer);
    }
}
