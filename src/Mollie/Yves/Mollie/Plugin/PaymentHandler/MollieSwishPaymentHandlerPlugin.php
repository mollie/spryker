 ...
 */
class MollieSwishPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMolliePaymentSwishHandler()->addPaymentToQuote($dataTransfer);
    }
}
