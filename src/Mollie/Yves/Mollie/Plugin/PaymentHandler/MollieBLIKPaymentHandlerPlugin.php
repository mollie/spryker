 ...
 */
class MollieBLIKPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMollieBlikPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
