 ...
 */
class MollieTrustlyPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMolliePaymentTrustlyHandler()->addPaymentToQuote($dataTransfer);
    }
}
