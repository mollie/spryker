 ...
 */
class MollieEpsPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMollieEpsPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
