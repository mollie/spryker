 ...
 */
class MollieApplePayPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
 /**
  ...
  */
    ...
    {
        return $this->getFactory()->createMollieApplePayPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
