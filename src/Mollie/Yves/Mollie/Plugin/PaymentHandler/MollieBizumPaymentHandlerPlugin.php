 ...
 */
class MollieBizumPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMollieBizumPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
