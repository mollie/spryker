 ...
 */
class MolliePayPalPaymentHandlerPlugin extends AbstractPlugin implements StepHandlerPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createMolliePayPalPaymentHandler()->addPaymentToQuote($dataTransfer);
    }
}
