...
class EnabledPaymentMethodsProvider extends AbstractPaymentMethodsProvider implements PaymentMethodsProviderInterface
{
    /**
...
//        $storeName = $this->storeClient->getCurrentStore()->getName();
        ...
        $billingCountry = $queryParametersTransfer->getBillingCountry() ?: 'null';
        $sequenceType = $queryParametersTransfer->getSequenceType() ?: 'oneoff';
        ...
        $key = MollieConstants::MOLLIE_STORAGE_ENABLED_PAYMENT_METHODS_KEY
        . static::DELIMITER
        . $storeName
        . static::DELIMITER
        . $mode
